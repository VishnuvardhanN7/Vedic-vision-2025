...
export default function SymptomChecker({ onClose, conditionLabel, symptomsList, demoFallbackAnswer }) {
  ...
  const handleCheckboxChange = (symptom) => {
    ...
    const painLevel = selectedImageIndex !== null ? images[selectedImageIndex].alt : null;
  ...
  const handleSubmit = async () => {
    ...
    const painLevel = selectedImageIndex !== null ? images[selectedImageIndex].alt : "Not selected";
...
This is ${conditionLabel} related. Analyze and respond in **Markdown** with:
...
Keep it clean, formal, and easy to read.
    ...
    try {
      const res = await axios.post(`${apiBase}/api/gpt`, { query });
      setResponse(res.data?.answer || demoFallbackAnswer);
      setShowResponsePopup(true);
    } catch (error) {
      console.error("Axios error:", error.response?.data || error.message);
      setResponse(error.response?.data?.answer || demoFallbackAnswer);
      setShowResponsePopup(true);
    } finally {
      setLoading(false);
    }
